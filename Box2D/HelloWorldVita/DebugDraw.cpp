...
#ifdef __VITA__
    printf("DebugDraw::DrawPolygon: not implemented\n");
#else
...
#ifdef __VITA__
    printf("DebugDraw::DrawSolidPolygon: not implemented\n");
#else
...
#ifdef __VITA__
    StartDrawing();
    vita2d_draw_fill_circle(center.x, center.y, radius,
                            RGBA8((int) color.r, (int) color.g, (int) color.b, (int) color.a));
#else
...
#ifdef __VITA__
    StartDrawing();
    vita2d_draw_line(p1.x, p1.y, p2.x, p2.y, RGBA8((int) color.r, (int) color.g, (int) color.b, (int) color.a));
#else
    m_lines->Vertex(p1, color);
    m_lines->Vertex(p2, color);
#endif
...
#ifdef __VITA__
    printf("DebugDraw::DrawTransform: not implemented\n");
#else
...
#ifdef __VITA__
    StartDrawing();
    vita2d_draw_fill_circle(p.x, p.y, size / 2, RGBA8((int) color.r, (int) color.g, (int) color.b, (int) color.a));
#else
...
void DebugDraw::DrawString(int x, int y, const char *string, ...) {
    ...
    va_start(arg, string);
    StartDrawing();
    vita2d_pgf_draw_textf(font, x, y, RGBA8(230, 153, 153, 0xFF), 1, string, arg);
    va_end(arg);
#else
    va_list arg;
    va_start(arg, string);
...
void DebugDraw::DrawString(const b2Vec2 &pw, const char *string, ...) {
    ...
    va_start(arg, string);
    StartDrawing();
    vita2d_pgf_draw_textf(font, ps.x, ps.y, RGBA8(230, 153, 153, 0xFF), 1, string, arg);
    va_end(arg);
#else
    va_list arg;
    va_start(arg, string);
...
#ifdef __VITA__
    unsigned int color = (unsigned int) RGBA8((int) c.r, (int) c.g, (int) c.b, (int) c.a);
    StartDrawing();
    vita2d_draw_line(p1.x, p1.y, p2.x, p2.y, color);
    vita2d_draw_line(p2.x, p2.y, p3.x, p3.y, color);
    vita2d_draw_line(p3.x, p3.y, p4.x, p4.y, color);
    vita2d_draw_line(p4.x, p4.y, p1.x, p1.y, color);
#else
    m_lines->Vertex(p1, c);
    m_lines->Vertex(p2, c);
